    ...
    app = create_app(
        {
            ...
            "MARKET_HEALTH_FILL_LOW": 0.5,
            "MARKET_HEALTH_FILL_HIGH": 0.8,
            "MARKET_HEALTH_ELIGIBLE_SUPPLY_LOW": 0.5,
            "MARKET_HEALTH_REJECT_VOLATILITY_THRESHOLD": 0.1,
            "MARKET_HEALTH_UNFILLED_STREAK_THRESHOLD": 3,
            "MARKET_HEALTH_REJECT_HEALTHY": 0.05,
            "ALPHA_PROFIT_BOOST_LOW_FILL": 0.2,
            "ALPHA_PROFIT_BOOST_LOW_SUPPLY": 0.1,
            "BETA_CTR_BOOST_HEALTHY": 0.1,
            "GAMMA_TARGETING_BOOST_LOW_FILL": 0.1,
            "GAMMA_TARGETING_BOOST_UNFILLED": 0.1,
            "DELTA_QUALITY_BOOST_LOW_FILL": 0.2,
            "DELTA_QUALITY_BOOST_VOLATILITY": 0.1,
            "PARTNER_QUALITY_NEW_CLICKS": 10,
            ...
            "PARTNER_QUALITY_DELTA_NEW": 0.8,
            "PARTNER_QUALITY_DELTA_STABLE": 1.0,
            "PARTNER_QUALITY_DELTA_RISKY": 1.5,
...
def test_partner_ad_response_explainable_and_requests_tracked(client, app):
    ...
    assert "alpha_profit" in payload["score_breakdown"]
    assert "beta_ctr" in payload["score_breakdown"]
    assert "gamma_targeting" in payload["score_breakdown"]
    assert "delta_quality" in payload["score_breakdown"]
    assert "partner_quality_state" in payload["score_breakdown"]
